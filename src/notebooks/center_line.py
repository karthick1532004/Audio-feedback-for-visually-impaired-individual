...
binary_image_path = 'D:/FIVETH SEM\system thinking/system_thinking/final_image_with_centerline.png'
binary_image = cv2.imread(binary_image_path, cv2.IMREAD_GRAYSCALE)

# Load the RGB image
rgb_image_path = 'D:/FIVETH SEM/system thinking/test5.jpg'
rgb_image = cv2.imread(rgb_image_path)

array = np.loadtxt("D:/FIVETH SEM/system thinking/system_thinking/binary_image.txt", delimiter=',')


img = cv2.imread('D:/FIVETH SEM/system thinking/test5.jpg',1)
...
minRoadWidth = 200#the minimum size the road needs to have to be a valid road in pixels
...
# Calculate centerline and draw it on the RGB image
